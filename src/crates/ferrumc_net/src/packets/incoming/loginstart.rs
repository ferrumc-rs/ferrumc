...
#[cfg(not(test))]
const NBT_CODEC: &[u8] = include_bytes!("../../../nbt_codec.nbt");
    ...
    async fn handle(&self, conn: &mut Connection) -> Result<()> {
...

        {
            let play_packet = crate::packets::outgoing::login_play::LoginPlay {
                ...
                registry_codec: Vec::from(NBT_CODEC),
        ...
        {
            let spawn_position = crate::packets::outgoing::defaultspawnposition::DefaultSpawnPosition {
