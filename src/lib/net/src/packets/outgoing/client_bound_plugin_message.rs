...
const SERVER_VERSION: &'static str = concat!("FerrumC v", env!("FERRUMC_VERSION"));
...
impl ClientBoundPluginMessagePacket {
    pub fn brand() -> ClientBoundPluginMessagePacket {
        ...
        SERVER_VERSION.encode(&mut data, &NetEncodeOpts::None).expect("failed to write brand name to buffer");
        Self {
