...
impl StateBehaviorTable {
    ...
    #[inline(always)]
    pub fn get_placement_state(&self, context: PlacementContext, world: &World, pos: BlockPos) -> u32 {
...
impl BlockBehaviorTable {
    ...
    fn convert_id<T: BlockBehavior>(id: u32, func: impl FnOnce(&mut T)) -> u32 {
        ...
        func(&mut data);
        data.try_into().unwrap_or_else(|_| panic!("Unknown block state"))
    }

    fn placement_state_for<T: BlockBehavior>(id: u32, context: PlacementContext, world: &World, pos: BlockPos) -> u32 {
